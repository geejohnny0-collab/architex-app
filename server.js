...
app.post('/api/jobs/apply', async (req, res) => {
    try {
        ...
        const newApp = {
          ...
          phone: manualDetails?.phone || req.body.phone || null,
          cityState: manualDetails?.cityState || req.body.cityState || null,
          resumeName: req.body.resumeName || 'Applicant_Resume.pdf',
          resumeUrl: req.body.resumeUrl || req.body.resumeData || null,
          currentTitle: manualDetails?.experiences?.[0]?.title || req.body.currentTitle || null,
          currentEmployer: manualDetails?.experiences?.[0]?.company || req.body.currentEmployer || null,
          yearsExperience: manualDetails?.yearsExperience || req.body.yearsExperience || null,
          technicalSkills: manualDetails?.technicalSkills || req.body.technicalSkills || null,
          desiredSalary: manualDetails?.desiredSalary || req.body.desiredSalary || null,
          desiredRate: manualDetails?.desiredRate || req.body.desiredRate || null,
          linkedIn: manualDetails?.linkedIn || req.body.linkedIn || null,
          gitHub: manualDetails?.gitHub || req.body.gitHub || null,
          portfolio: manualDetails?.portfolio || req.body.portfolio || null,
          noticePeriod: manualDetails?.noticePeriod || req.body.noticePeriod || null,
          workAuth: manualDetails?.workAuth || req.body.workAuth || null,
